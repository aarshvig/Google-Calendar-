...
var l=document.getElementsByTagName('*').length;
 document.getElementById("tatoo").innerHTML="kk"+l;
for(var i=0;i<document.getElementsByTagName('*').length;i++)
{		
		if(document.getElementsByTagName('*')[i].className == 'fc-header-title')
					{
                    mname=document.getElementsByTagName("*")[i].innerHTML;
                        document.getElementById("tatoo").innerHTML="kk";
				     
				     switch(mname[0])
                    {
                        case 'J' : switch(mname[1])
                        			{
                                        case 'a':getElementById("aman").style.background-image=url("{{=URL('static','images/a.jpg')}}");
                                       			 break;
                                        case 'u':if(mname[2]=='n')
                                       			 getElementById("aman").style.background-image=url("{{=URL('static','images/a.jpg')}}");
                                       			 else
                                       			 getElementById("aman").style.background-image=url("{{=URL('static','images/a.jpg')}}");
                                        ...
                                        break;
                        case 'F' :  getElementById("aman").style.background-image=url("{{=URL('static','images/a.jpg')}}");
                                    break;
                        case 'M' : if(mname[2]=='r')
                                         getElementById("aman").style.background-image=url("{{=URL('static','images/a.jpg')}}");
                                   else
                        ...
                        case 'A' : if(mname[1]=='p')
                                         ...
                                         getElementById("aman").style.background-image=url("{{=URL('static','images/a.jpg')}}");
                                   break;
                        case 'S' : getElementById("aman").style.background-image=url("{{=URL('static','images/a.jpg')}}");
                                   break;
                        case 'O' : getElementById("aman").style.background-image=url("{{=URL('static','images/a.jpg')}}");     
                                   break;
                         case 'N' : getElementById("aman").style.background-image=url("{{=URL('static','images/a.jpg')}}");     
                                   break;
                         case 'D' : getElementById("aman").style.background-image=url("{{=URL('static','images/a.jpg')}}");     
                                   break; 
                    } 
